...
import { getAllAreas, getAllActions, getAllIncidenceTypes, getAllStatus, getAllUsersAuthorize, registerNonConformity, getNonConformity } from '../../context/nonConformitiesContext/apiCalls';
...
function NonConformities() {
    ...
    const onSubmit = (data, event) => {
        ...
        setStatusNc("Nueva");
        const registerResult = registerNonConformity(data)
            .then(() => {
    ...
    useEffect(() => {
        ...
        async function fetchNonConformity(ncId){
            ...
            setAutorizoId(nonConformity.autorizoId);
    ...
    return (
        <div className="moduleContainer">
            ...
            <div className='breadCrumb'>
                <a href="/nonConformitiesList">Lista No Conformidades</a> &gt; Alta No Conformidades
            </div>
